...
export function MagazinesNewspapersCta() {
  const benefits = [
    ...
    "Advanced reader analytics and insights",
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl lg:text-5xl font-bold text-white leading-tight">
                Start Your Digital Publishing Revolution Today
              </h2>
              <p className="text-xl text-blue-100 leading-relaxed">
                Join hundreds of successful magazines and newspapers that have transformed their digital presence with
                our comprehensive publishing platform.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-blue-200">Average results across our clients</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/10 p-4 rounded-lg border border-white/20">
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-sm text-blue-200 font-medium">Readership Growth</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-blue-200">Time to Market</span>
                      <div className="flex items-center">
                        <div className="w-24 bg-white/20 rounded-full h-2 mr-2">
                          <div className="bg-green-400 h-2 rounded-full w-5/6"></div>
                        </div>
                        <span className="text-sm font-medium text-green-400">85% faster</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-blue-200">Operational Efficiency</span>
                      <div className="flex items-center">
                        <div className="w-24 bg-white/20 rounded-full h-2 mr-2">
                          <div className="bg-blue-400 h-2 rounded-full w-3/4"></div>
                        </div>
                        <span className="text-sm font-medium text-blue-400">75% improvement</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-blue-200">Reader Satisfaction</span>
                      <div className="flex items-center">
                        <div className="w-24 bg-white/20 rounded-full h-2 mr-2">
                          <div className="bg-purple-400 h-2 rounded-full w-11/12"></div>
                        </div>
                        <span className="text-sm font-medium text-purple-400">92% rating</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 p-4 rounded-lg border border-white/20 text-center">
                  <div className="text-sm text-blue-200 mb-2">Ready to see these results?</div>
                  <div className="text-lg font-semibold text-white">Start your 30-day free trial</div>

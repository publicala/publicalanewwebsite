      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6">Powerful Integrations</h1>
            <p className="text-lg text-gray-600 mb-8">
              Connect your publishing platform with your favorite tools and services through our extensive integration
              options.
            </p>
          ...
          <div className="relative">
            <div className="relative z-10 rounded-lg shadow-xl overflow-hidden border border-gray-200 bg-gray-100 h-80 flex items-center justify-center">
              <p className="text-gray-500">Integrations Preview</p>
            </div>

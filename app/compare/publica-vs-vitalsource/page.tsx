...
export default function PublicaVsVitalSourcePage() {
  return (
      ...
      <section className="pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Inclusive Platform vs. <span className="text-primary">Academic Ecosystem</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-4xl mx-auto">
            Compare publica.la's comprehensive, publisher-first platform with VitalSource's academic-focused
            institutional delivery system.
          </p>
          <CalendlyButton text="Schedule a Demo" size="lg" />
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                delivery, analytics, and accessibility—but is often institution-driven and limited in direct-to-consumer
                flexibility.
              </p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr>
                    <td className="px-6 py-4 font-medium">Your main focus is eTextbook delivery within universities</td>
                    <td className="px-6 py-4 text-center">
                      <div className="flex items-center justify-center space-x-2">
                        <AlertTriangle className="h-5 w-5 text-yellow-500" />
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8 mb-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              publica.la offers a more flexible, direct, and globally compliant platform, making it ideal for publishers
              looking to expand reach, control margins, and own their audience—whether in academia, trade, or
          ...
          <CalendlyButton text="Schedule a Demo" size="lg" className="mb-4" />

        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section id="what-we-do" className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed">
              Publica.la helps publishers sell and deliver digital content directly to their readers. We are growing our mobile and web apps with a shared TypeScript core. You will work mostly on React Native and the frontend, and jump into light Node.js scripting when it helps.
            </p>
          </section>
          ...
          <section id="requirements" className="mb-12">
            ...
            <ul className="space-y-3 text-gray-700 list-disc list-inside">
              ...
              <li>Communicate clearly in English and Spanish.</li>
            </ul>
          </section>
